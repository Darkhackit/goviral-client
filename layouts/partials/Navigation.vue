                ...
                <div class="row align-items-center">
                        ...
                        <div class="header-top-navigation">
                            <nav>
                                <ul>
                                    ...
                                    <li class="" v-if="!$auth.loggedIn">
                                        <nuxt-link to="/login">Login/Signup</nuxt-link>
                                    </li>

                                    <li class="msg-trigger" v-if="$auth.loggedIn"><a class="msg-trigger-btn" href="#a">message</a>
                                    ...
                                    <li class="notification-trigger" v-if="$auth.loggedIn"><a class="msg-trigger-btn" href="#b">notification</a>
                    ...
                    <div class="col-md-5">
                        <div class="header-top-right d-flex align-items-center justify-content-end">
                            ...
                            <div class="profile-setting-box" v-if="$auth.loggedIn">
                                <div class="profile-thumb-small">
                                    ...
                                    <div class="profile-dropdown">
                                        ...
                                        <div class="profile-body">
                                            ...
                                            <ul>
                                                <li>
                                                    <nuxt-link to="/settings"><i class="flaticon-settings"></i>Setting</nuxt-link>
                                                </li>
                                                <li @click.prevent="logout"><a href="#"><i class="flaticon-unlock"></i>Sing out</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="profile-dropdown text-left">
                            ...
                            <div class="profile-body">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#"><i class="flaticon-unlock" @click.prevent="logout"></i>logout</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
